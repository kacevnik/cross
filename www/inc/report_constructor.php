<?php
    ...
    if($crossData['time_of_public'] == 1){$public_date = '<span class="public_date">Дата не заданна</span>';}else{$public_date = '<span class="public_date">'.date("H:i d-m-Y",$crossData['time_of_public']).'</span>';}
