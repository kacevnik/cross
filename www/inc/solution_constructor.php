<?php
    ...
    if(mysqli_num_rows($selCross) > 0){
        ...
        echo "<div class='error'>Ошибка запроса. Попробуйте еще раз</div>";
    }
    
    if($solutionCross != $solution){unset($solution); echo "<div class='error'>Неверное решение. Где-то ошибка.</div>";}
