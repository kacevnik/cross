<?php
    ...
    if($u){
        $pass = substr($u, 0, 32);
        $kod  = substr($u, 32, 32);
        $res = mysql_query("SELECT login_view,email,name,phone,dis FROM voditel WHERE pass='$pass' AND kod='$kod'", $db);
